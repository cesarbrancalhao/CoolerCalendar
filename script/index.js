(function ($, undefined) {
	...
	var dateFormatters = {
		...
		h: function (d) { return d.getHours() || 0 },
		hh: function (d) { return zeroPad(d.getHours() || 12) },
	...
	function AgendaEventRenderer() {
		...
		function renderSlotSegs(segs, modifiedEventId) {
			...
			segs.forEach(s => {
				const e = [s.event.start, s.event.end, s.event.allDay, s.event.title, s.event.description, s.event.situacao, s.event.id, false];
				s.element.on('click', () => {
					modalForm(...e);
				});
			});
		...
		function slotSegHtml(event, seg) {
			...
			html +=
				...
				(situacoes[event.situacao] || "primarybg") +
				"'>" +
				...
				"<span class='situacao' style='display:none'>" + event.situacao + "</span>" +
	...
	function DayEventRenderer() {
		...
		function buildHTMLForSegment(segment) {
			...
			html += "<span class='event-id' style='display:none'>" + event.id + "</span>";
			html += "<span class='description' style='display:none'>" + event.description + "</span>";
			html += "<span class='situacao' style='display:none'>" + event.situacao + "</span>";
			html +=
